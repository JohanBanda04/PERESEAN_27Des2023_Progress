...
and zona_dokumen='$zona' and id_perancang=".$this->session->userdata('id_user')." order by id_draft_permohonan DESC");
...
and zona_dokumen='$zona' and id_perancang=".$this->session->userdata('id_user')." order by id_draft_permohonan DESC");
            ...
            if($this->session->userdata('tahun')=="2023"){
                $data['query'] = $this->db->query("select * from tbl_draft 
where left(tgl_input,4)=".$this->session->userdata('tahun')." 
and zona_dokumen='$zona' order by id_draft_permohonan DESC");
            } else if($this->session->userdata('tahun')=="2024"){
                $data['query'] = $this->db->query("select * from tbl_draft 
where left(tgl_input,4)=".$this->session->userdata('tahun')." 
and zona_dokumen='$zona' order by id_draft_permohonan DESC");
...
//							redirect("harmonisasi/v/t");
        ...
        if (isset($_POST['btnsimpan_update_kasub_perancang'])) {
            //echo "update kasub perancang ASLIII"; die;
//            echo $zona; die;
//            echo $id; die;
