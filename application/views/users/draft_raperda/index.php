        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Draft Raperda /
                        Raperkada <?= $cek_nama_panjang_zona->row()->nama_panjang ?></h4>
                        ...
                        if ($this->session->userdata('level') != "perancang") {
                            ...
                            <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/<?= $link3; ?>/t.html"
                               class="btn btn-primary"><i
                                        class="fa fa-plus-circle"></i> Tambah Dokumen Draft </a>
                            <?php
                        }
				...
				Assalamualaikum,...%0a
				Kami dari *<?= $this->session->userdata('nama_lengkap') ?>*, ingin mengajukan permohonan harmonisasi dengan judul
			...
			" id="kirimWa" name="kirimWa" target="_blank">
				...
				Assalamualaikum,...%0a
				Telah terdapat pendelegasian harmonisasi raperda /raperkada dari *<?= $this->session->userdata('nama_lengkap') ?>*, dengan judul draft
				<?php echo " *" . $baris->nama_draft_permohonan ?>*, %0a
			...
			" id="kirimWa" name="kirimWa" target="_blank">
                                ...
                                <div class="modal fade"
                                     id="detail_draft_berita<?php echo $baris->id_draft_permohonan; ?>">
